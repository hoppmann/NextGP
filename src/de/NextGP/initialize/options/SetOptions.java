...
public class SetOptions {
	...
	private void makeOptions() {
		...
		opts.put(misc, new OptionValue(options, "email", false, "If set, a notice of failing or finishing will be send to the corresponding e-mail adress deposed in slurm."));
	}
